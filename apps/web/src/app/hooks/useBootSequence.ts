...
const BOOT_LINES: BootLine[] = [
  ...
  { text: 'v0.1.0 // PHASE 1 — SHELL & DESIGN SYSTEM', delay: 120 },
  { text: '', delay: 200 },
  { text: 'Initializing engine core...', delay: 280 },
  { text: 'RNG channels: 7 seeded [OK]', delay: 400 },
  { text: 'Event system: 13 types [OK]', delay: 480 },
  { text: 'Config loaded: positions, schemes, coaching, cap-math [OK]', delay: 600 },
  { text: 'Systems online: traits, personality, archetypes [OK]', delay: 720 },
  { text: 'Save pipeline: Zod validation + Dexie slots [OK]', delay: 840 },
  { text: '', delay: 900 },
  { text: 'Design system: Terminal Maximalism 3.0', delay: 1000 },
