...
const recordSourceRows = [
  {
    id: 'record-book',
    label: 'Saved record book',
    badge: 'game.records',
    accent: 'gold',
    detail: 'Tables read saved single-game, single-season, career, and franchise buckets. This route does not detect or write new records.',
  },
  {
    id: 'record-chases',
    label: 'Weekly chase receipts',
    badge: 'activeRecordChases',
    accent: 'cyan',
    detail: 'Active Chases shows saved pace receipts from weekly advancement, not a live recalculation during render.',
  },
  {
    id: 'recent-records',
    label: 'Fresh breaks',
    badge: 'recentBrokenRecords',
    accent: 'green',
    detail: 'Recent Records shows the saved post-week queue from record detection and keeps it separate from the all-time tables.',
  },
  {
    id: 'milestones',
    label: 'Milestone receipts',
    badge: 'recentMilestones',
    accent: 'default',
    detail: 'Milestones are saved weekly receipts, separate from the app-shell MilestoneCard overlay.',
  },
  {
    id: 'media-boundary',
    label: 'Media boundary',
    badge: 'no render-time news',
    accent: 'default',
    detail: 'Record news, social posts, storylines, and ceremonies are generated by engine week/offseason paths, not by opening this route.',
  },
] as const;
