  ...
  cleanWin: [
    {
      ...
      text: 'Win travels. Standards stay.',
      archetype: 'weekly',
  ...
  uglyWin: [
    {
      ...
      reducedMotionPose: 'talk',
      text: 'Win column held. Film has questions.',
      archetype: 'weekly',
      cooldownMs: WEEKLY_DIALOGUE_COOLDOWN_MS,
      priority: 3,
    },
  ...
  loss: [
    {
      ...
      text: 'Bad tape. Useful tape. Fix the first leak.',
      archetype: 'weekly',
      cooldownMs: WEEKLY_DIALOGUE_COOLDOWN_MS,
      priority: 3,
    },
  ...
  blowoutLoss: [
    {
      ...
      pose: 'head-in-hands',
      reducedMotionPose: 'idle',
      text: 'Room changed after halftime. Start with the position group that cracked.',
      archetype: 'weekly',
      cooldownMs: WEEKLY_DIALOGUE_COOLDOWN_MS,
      priority: 4,
    },
  ...
  threeLossStreak: [
    {
      ...
      pose: 'head-in-hands',
      reducedMotionPose: 'idle',
      text: 'Three straight. No miracle. One clean decision.',
      archetype: 'weekly',
      cooldownMs: WEEKLY_DIALOGUE_COOLDOWN_MS,
      priority: 5,
    },
  ...
  midseason: [
    {
      ...
      reducedMotionPose: 'talk',
      text: 'Midseason board. Standings talk. Injuries whisper.',
      archetype: 'weekly',
      cooldownMs: WEEKLY_DIALOGUE_COOLDOWN_MS,
      priority: 2,
    },
  ...
  preseason: [
    {
      ...
      pose: 'reviewing-tablet',
      reducedMotionPose: 'idle',
      text: 'Preseason desk is live. Depth chart earns trust now.',
      archetype: 'weekly',
      cooldownMs: WEEKLY_DIALOGUE_COOLDOWN_MS,
      priority: 2,
    },
  ...
  playoffs: [
    {
      ...
      pose: 'rallying',
      reducedMotionPose: 'talk',
      text: 'Different room. Mistakes echo. Check the boring stuff first.',
      archetype: 'weekly',
      cooldownMs: WEEKLY_DIALOGUE_COOLDOWN_MS,
      priority: 4,
    },
  ...
  championship: [
    {
      ...
      pose: 'proud',
      reducedMotionPose: 'talk',
      text: 'The trophy changes the questions. Good.',
      archetype: 'weekly',
      cooldownMs: WEEKLY_DIALOGUE_COOLDOWN_MS,
      priority: 5,
    },
  ...
  darkMoment: [
    {
      ...
      pose: 'facepalm',
      reducedMotionPose: 'idle',
      text: 'Bad night. No permanent decisions while the scoreboard is loud.',
      archetype: 'weekly',
      cooldownMs: WEEKLY_DIALOGUE_COOLDOWN_MS,
      priority: 5,
    },
