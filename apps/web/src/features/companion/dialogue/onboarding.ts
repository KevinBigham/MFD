...
const onboardingDialogueEntries: DialogueCatalogEntry[] = [
  ...
  },
  {
    ...
    text: 'Must Do: open the highlighted Intel card. It names whether roster, cap, staff, or owner patience needs action first before Week 1.',
    contextDetails: [
  ...
  },
  {
    ...
    beat: 4,
    pose: 'calling-play',
    text: "Must Do: hire the coach whose calls match today's starters. A coach-player pairing that does not match slows install, costs development reps, and exposes Week 1 assignments.",
    contextDetails: [
  ...
  },
  {
    ...
    beat: 9,
    pose: 'concern',
    text: 'Must Do: pick promises the roster must defend. Owner goals become expectations; missed promises cut owner patience even after roster upgrades.',
    contextDetails: [
