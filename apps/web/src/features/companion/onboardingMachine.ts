...
export const FIRST_TEN_MINUTE_ONBOARDING_BEATS: readonly ChipOnboardingBeat[] = [
  {
    ...
    route: '/',
    pose: 'point-side',
    text: 'Monday Briefing sets the board: injuries, owner heat, next opponent.',
  ...
  },
  {
    ...
    route: '/roster',
    pose: 'thinking',
    text: 'Injuries and thin rooms first. Game plan follows personnel.',
  ...
  },
  {
    ...
    route: '/depth-chart',
    pose: 'point-side',
    text: 'Set the Sunday lineup. Backup order becomes real fast.',
  ...
  },
  {
    ...
    route: '/game-plan',
    pose: 'thinking',
    text: 'Pick a plan your roster can execute.',
  ...
  },
  {
    ...
    route: '/week-advance',
    pose: 'thinking',
    text: 'This turns choices into standings. Clear the red first.',
