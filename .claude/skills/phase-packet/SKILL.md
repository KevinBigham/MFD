...
- Honor CLAUDE.md Prime Laws (determinism, schema, no silent math).

VERIFICATION (all must pass before reporting done):
- <exact commands per CLAUDE.md verification defaults for the
  packages touched>
...
lane · scope or cost doubles · anything in CLAUDE.md Kevin gates.
