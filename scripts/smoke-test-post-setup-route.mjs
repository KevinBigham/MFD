...
async function runCartridgeRoundTripSmoke(cdp, sessionId, baseUrl, postImportRouteCheck = null, postImportOptions = {}) {
  ...
  await clickButtonContaining(cdp, sessionId, 'Copy Cartridge', 'clickable Copy Cartridge button');
...
async function runCartridgeFileRoundTripSmoke(cdp, sessionId, baseUrl, postImportRouteCheck = null, postImportOptions = {}) {
  ...
  await clickButtonContaining(cdp, sessionId, 'Download .mfd', 'clickable Download .mfd button');
...
async function runG6StateFeedbackSmoke(cdp, sessionId, baseUrl) {
  ...
  await clickButtonContaining(cdp, sessionId, 'Import Backup Code', 'clickable Import Backup Code button for invalid backup');
