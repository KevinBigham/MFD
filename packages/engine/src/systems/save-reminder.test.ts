...
describe('save reminder system', () => {
  it('shows a reminder at year five with no previous manual save', () => {
  ...
  it('suppresses the reminder when a manual save happened this season window', () => {
    expect(shouldShowSaveReminder(10, 8)).toBe(false);
  });

  it('shows a reminder again at year ten when the last manual save was year five', () => {
